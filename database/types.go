...
type Config struct {
	...
	SSL      bool   `yaml:"ssl" env:"DATABASE_SSL" env-description:"Enable SSL for database connection"`
	Cert     string `yaml:"ssl_cert" env:"DATABASE_SSL_CERT" env-description:"SSL certificate for database connection"`
}
